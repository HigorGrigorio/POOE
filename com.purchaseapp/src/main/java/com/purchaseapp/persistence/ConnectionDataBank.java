package com.purchaseapp.persistence;
...
public class ConnectionDataBank {
	...
	private EntityManagerFactory getFactory() {
		...
		properties.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/purchaseapp");
		...
		properties.put("hibernate.default_schema", "purchaseapp");

		return Persistence.createEntityManagerFactory("purchaseapp", properties);
	}
}
